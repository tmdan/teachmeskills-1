                            ...
                            <div class="post-content">
                                ...
                                <div class="entry-content">
                                    ...
                                    <div class="btn-continue-reading text-center text-uppercase">
                                        <a href="{{route('posts.show', $post->slug)}}" class="more-link">Continue
                                            Reading</a>
                                    </div>
                                </div>
                                <div class="social-share">
                                    {{--                            <span class="social-share-title pull-left text-capitalize">By <a href="#">{{$post->author->name}}</a> On {{$post->created_at}}</span>--}}
